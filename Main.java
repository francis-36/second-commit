...
public class Main {
    public static void main(String[] args) {
      ...
      /*  System.out.printf("%c\n", phrase1.getLettre(-1));
        ...
        System.out.print(chaine4.getMot(0));
        System.out.print(chaine4.getMot(2));
        System.out.println(chaine4.getMot(5));

        System.out.print(chaine4.getLettre(1, 0) + " ");
        System.out.print(chaine4.getLettre(1, 2) + " ");
        System.out.println(chaine4.getLettre(1, 4));

        System.out.print(chaine4.getLettre(0) + " ");
        System.out.print(chaine4.getLettre(12) + " ");
        System.out.println(chaine4.getLettre(40));
